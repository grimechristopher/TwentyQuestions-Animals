...
:- dynamic name/1, category/1, habitat/1, diet/1.
...
hunting_technique('Venom Strike').
burrowing_behavior('Non-Burrowing').
...
% Number of individuals in a typical group
group_size(4).
nest_location('Freshwater Plants').
migration(false).
hunting_technique('Ambush').
...
% Number of individuals in a typical group
group_size(10).
nest_location('Underground Colony').
migration(false).
hunting_technique('Foraging').
hunting_technique('Grazing').
burrowing_behavior('Tunneling').
...
% From black_capped_chickadee.pl
...
nest_location('Reef').
migration(false).
hunting_technique('Stomach Eversion').
burrowing_behavior('Non-Burrowing').
...
migration(false).
hunting_technique('Grazing').
hunting_technique('Wading').
burrowing_behavior('Non-Burrowing').


% From red_tailed_hawk.pl
...
habitat('Coastal').
% Temperature in Fahrenheit
preferred_environment_temperature(32).
% Territory size in square miles
territory_size_sq_miles(0).
...
% Number of individuals in a typical group
group_size(100).
nest_location('Ice Sheet').
migration('Seasonal').
hunting_technique('Diving').
hunting_technique('Tusking').
burrowing_behavior('Non-Burrowing').
...
% Diet
diet('Herbivore').
diet_preference('Eucalyptus Leaves').
...
% From chilean_rose_tarantula.pl
...
habitat('Desert').
% Temperature in Fahrenheit
preferred_environment_temperature(90).
% Territory size in square miles
territory_size_sq_miles(0.1).
...
hibernates(false).
lives_in_groups(true).
social_bonding_level('Loose Groups').
hoarding_behavior(false).
...
intelligence_level('Simple').
cheek_pouches(false).
human_usage('Pollination').
% Number of individuals in a typical group
group_size(10).
nest_location('Various').
migration('Long Distance').
hunting_technique('Foraging').
burrowing_behavior('Non-Burrowing').


% From house_spider.pl
name('House Spider').
...
habitat('Coastal').
% Temperature in Fahrenheit
preferred_environment_temperature(40).
% Territory size in square miles
territory_size_sq_miles(3000).
...
migration('Long Distance').
hunting_technique('Filter Feeding').
hunting_technique('Lunge Feeding').
burrowing_behavior('Non-Burrowing').
...
diet('Carnivore').
diet_preference('Insects').
diet_preference('Small Vertebrates').
...
nest_location('Underground').
migration(false).
hunting_technique('Constriction').
hunting_technique('Ambush').
burrowing_behavior('Non-Burrowing').
...
diet_preference('Commercial Feed').
...
human_usage('Pets').
human_usage('Service').
human_usage('Protection').
% Number of individuals in a typical group
group_size(6).
nest_location('Human Structures').
migration(false).
...
migration(false).
hunting_technique('Electroreception').
hunting_technique('Diving').
burrowing_behavior('Non-Burrowing').
...
% Diet
diet('Carnivore').
diet_preference('Aphids').
diet_preference('Scale Insects').
...
% From madagascar_hissing_cockroach.pl
...
eggs_per_clutch(60).
% Number of clutches per year
clutches_per_year(4.5).

% Diet
diet('Omnivore').
diet_preference('Plant Matter').
...
% Number of individuals in a typical group
group_size(1000).
nest_location('Tree Branches').
migration(false).
hunting_technique('Piercing-Sucking').
burrowing_behavior('Non-Burrowing').
...
nest_location('Tree Cavity').
migration(false).
hunting_technique('Silent Flight').
hunting_technique('Ambush').
burrowing_behavior('Non-Burrowing').
...
% Number of individuals in a typical group
group_size(1).
nest_location('River Bottom').
migration(false).
hunting_technique('Electrical Discharge').
hunting_technique('Stunning').
burrowing_behavior('Non-Burrowing').
...
migration('Seasonal').
hunting_technique('Diving').
hunting_technique('Swooping').
burrowing_behavior('Non-Burrowing').


% From shoebill_stork.pl
name('Shoebill Stork').
...
nest_location('Ground Level').
migration(false).
hunting_technique('Stand Hunting').
hunting_technique('Crushing').
burrowing_behavior('Non-Burrowing').
...
% From white_breasted_nuthatch.pl
...
nest_location('Tree Cavity').
migration(false).
hunting_technique('Bark Gleaning').
hunting_technique('Probing').
burrowing_behavior('Non-Burrowing').
...
% Number of individuals in a typical group
group_size(30).
nest_location('Building Cavities').
migration('Some').
hunting_technique('Ground Feeding').
hunting_technique('Gleaning').
burrowing_behavior('Non-Burrowing').
...
cheek_pouches(false).
human_usage('Tourism').
human_usage('Traditional Use').
% Number of individuals in a typical group
group_size(20).
nest_location('Open Ocean').
migration('Seasonal').
hunting_technique('Deep Diving').
hunting_technique('Suction Feeding').
burrowing_behavior('Non-Burrowing').
...
cheek_pouches(false).
human_usage('Food').
human_usage('Aquaculture').
% Number of individuals in a typical group
group_size(100).
nest_location('Sandy Depression').
migration(false).
hunting_technique('Filter Feeding').
hunting_technique('Grazing').
burrowing_behavior('Non-Burrowing').
...
tree_climbing('Professional').
fishing_ability('Poor').
speech_capability('Advanced Speech').
...
nest_location('Reef').
migration(false).
hunting_technique('Venomous Spines').
burrowing_behavior('Non-Burrowing').
...
% Diet
diet('Omnivore').
diet_preference('Decomposing Matter').
...
% Number of individuals in a typical group
group_size(50).
nest_location('Organic Matter').
migration(false).
hunting_technique('Scavenging').
hunting_technique('Lapping').
burrowing_behavior('Non-Burrowing').
...
habitat('Arctic').
% Temperature in Fahrenheit
preferred_environment_temperature(30).
% Territory size in square miles
territory_size_sq_miles(1000).
...
% Number of individuals in a typical group
group_size(1).
nest_location('Snow Den').
migration('Seasonal').
hunting_technique('Still Hunting').
hunting_technique('Stalking').
burrowing_behavior('Burrow User').
...
nest_location('Open Ocean').
migration(true).
hunting_technique('Stinging').
hunting_technique('Drifting').
burrowing_behavior('Non-Burrowing').
...
nest_location('Hive').
migration(false).
hunting_technique('Nectar Collection').
hunting_technique('Pollen Gathering').
burrowing_behavior('Non-Burrowing').
...
% Diet
diet('Carnivore').
diet_preference('Flying Insects').
...
% Number of individuals in a typical group
group_size(1).
nest_location('Water Plants').
migration(false).
hunting_technique('Aerial Hunting').
burrowing_behavior('Non-Burrowing').
